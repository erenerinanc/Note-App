...
//        let attributedString = NSMutableAttributedString(string: getNoteTitle() ?? "")
//        attributedString.addAttribute(.font, value: UIFont.systemFont(ofSize: 16), range: NSRange(location: 0, length: 10))
//    }
